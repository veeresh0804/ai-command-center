    ...
    <section id="contact" className="section-padding relative" ref={ref}>
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            <div>
              <label className="mb-1.5 block font-mono text-xs tracking-wider text-muted-foreground">
                NAME
              </label>
              <input
                type="text"
                ...
                className="w-full rounded-lg border border-border bg-muted/50 px-4 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-primary"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-border bg-muted/50 px-4 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-primary"
          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Mail, label: "Email", href: "mailto:dev@example.com", handle: "dev@example.com" },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.href}
